...
define
   ...
   fun{SpecialToSpace List ResList}
      ...
      [] H|T then 
         ...
         if H == 32 then {SpecialToSpace T H|ResList}
         elseif H == 10 then {SpecialToSpace T 32|ResList}
         elseif H == 47 then {SpecialToSpace T 32|ResList}
         elseif H == 39 then {SpecialToSpace T 32|ResList}
         elseif H == 96 then {SpecialToSpace T 32|ResList}
   ...
   fun {StripPonctuation Str}
      {List.reverse {SpecialToSpace Str nil}}
   end

   fun {FilterDoubleSpace Str} 
      fun{FilterDoubleSpaceAcc Str Res}
         case Str of
         nil then Res
         [] H|T1 then 
            case T1 of
            ...
            [] H2|T2 then 
               if H == 32 then 
                  if H2 == 32 then {FilterDoubleSpaceAcc T1 Res}
                  else {FilterDoubleSpaceAcc T1 H|Res} end
               else {FilterDoubleSpaceAcc T1 H|Res} end
            end
         end    
      end
   in 
      {List.reverse {FilterDoubleSpaceAcc Str nil}}
   end
